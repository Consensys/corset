...
//#cgo CFLAGS: -I./target/
//#cgo LDFLAGS: ./target/release/libcorset.so
//#include <corset.h>
import "C"
import "fmt"
import "unsafe"
...
// |                                                                                                  |
// |  struct ColumnsRegister *trace_compute(const char *zkevmfile,                                    |
// |                                        const char *tracefile,                                    |
// |                                        unsigned int threads,                                     |
// |                                        bool fail_on_missing);                                    |
// |  void trace_free(struct ColumnsRegister *ptr);                                                   |
// |                                                                                                  |
// |                                                                                                  |
// |  * Get the number of columns in the trace                                                        |
// |                                                                                                  |
// |  unsigned int trace_column_count(const struct ColumnsRegister *ptr);                             |
// |                                                                                                  |
// |                                                                                                  |
// |  * Get all column names; position in array == ID of the column                                   |
// |                                                                                                  |
// |  char *const *trace_column_names(const struct ColumnsRegister *ptr);                             |
// |                                                                                                  |
// |                                                                                                  |
// |  * Get column values, either by name or by ID (faster)                                           |
// |                                                                                                  |
// |  struct ColumnData trace_column_by_name(const struct ColumnsRegister *ptr, const char *name);    |
// |  struct ColumnData trace_column_by_id(const struct ColumnsRegister *ptr, uint32_t i);            |
// |                                                                                                  |
// |  * What's in a column                                                                            |
// |                                                                                                  |
...
func getColumnNames(trace *C.ColumnsRegister) (r []string) {
...
func main() {
	...
	col := C.trace_column_by_name(trace, C.CString("rom__INV_rom_CODE_FRAGMENT_INDEX"))
